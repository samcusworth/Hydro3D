...
!##########################################################################
        ...
        do k=no1,nk+no2; do j=no1,nj+no2; do i=no1-1,ni+no2
        tr1=fi(i,j-1,k-1); tr2=fi(i,j,k-1); tr3=fi(i,j+1,k-1)
        tr4=fi(i,j-1,k);   tr5=fi(i,j,k);   tr6=fi(i,j+1,k)
        tr7=fi(i,j-1,k+1); tr8=fi(i,j,k+1); tr9=fi(i,j+1,k+1)

!        ii=2*i-pl; jj=2*j-pl-1; kk=2*k-pl-1; !(j,k)
...
!        ii=2*i-pl; jj=2*j-pl; kk=2*k-pl-1; !(j+1,k)
...
!        ii=2*i-pl; jj=2*j-pl-1; kk=2*k-pl; !(j,k+1)
...
!        ii=2*i-pl; jj=2*j-pl; kk=2*k-pl; !(j+1,k+1)
...
!!!!
        ...
        tr1=0.5*(fi(i,j-1,k-1)+fi(i+1,j-1,k-1))
        tr2=0.5*(fi(i,j,k-1)+fi(i+1,j,k-1))
        tr3=0.5*(fi(i,j+1,k-1)+fi(i+1,j+1,k-1))
        tr4=0.5*(fi(i,j-1,k)+fi(i+1,j-1,k))
        tr5=0.5*(fi(i,j,k)+fi(i+1,j,k))
        tr6=0.5*(fi(i,j+1,k)+fi(i+1,j+1,k))
        tr7=0.5*(fi(i,j-1,k+1)+fi(i+1,j-1,k+1))
        tr8=0.5*(fi(i,j,k+1)+fi(i+1,j,k+1))
        tr9=0.5*(fi(i,j+1,k+1)+fi(i+1,j+1,k+1))

!        tr1=0.0625*(9.0d0*fi(i,j-1,k-1)+9.0d0*fi(i+1,j-1,k-1)
!     & -fi(i-1,j-1,k-1)-fi(i+2,j-1,k-1))
!        tr2=0.0625*(9.0d0*fi(i,j,k-1)+9.0d0*fi(i+1,j,k-1)
!     & -fi(i-1,j,k-1)-fi(i+2,j,k-1))
!        tr3=0.0625*(9.0d0*fi(i,j+1,k-1)+9.0d0*fi(i+1,j+1,k-1)
!     & -fi(i-1,j+1,k-1)-fi(i+2,j+1,k-1))
!        tr4=0.0625*(9.0d0*fi(i,j-1,k)+9.0d0*fi(i+1,j-1,k)
!     & -fi(i-1,j-1,k)-fi(i+2,j-1,k))
!        tr5=0.0625*(9.0d0*fi(i,j,k)+9.0d0*fi(i+1,j,k)
!     & -fi(i-1,j,k)-fi(i+2,j,k))
!        tr6=0.0625*(9.0d0*fi(i,j+1,k)+9.0d0*fi(i+1,j+1,k)
!     & -fi(i-1,j+1,k)-fi(i+2,j+1,k))
!        tr7=0.0625*(9.0d0*fi(i,j-1,k+1)+9.0d0*fi(i+1,j-1,k+1)
!     & -fi(i-1,j-1,k+1)-fi(i+2,j-1,k+1))
!        tr8=0.0625*(9.0d0*fi(i,j,k+1)+9.0d0*fi(i+1,j,k+1)
!     & -fi(i-1,j,k+1)-fi(i+2,j,k+1))
!        tr9=0.0625*(9.0d0*fi(i,j+1,k+1)+9.0d0*fi(i+1,j+1,k+1)
!     & -fi(i-1,j+1,k+1)-fi(i+2,j+1,k+1))

!        ii=2*i-pl+1; jj=2*j-pl-1; kk=2*k-pl-1; !(j,k)
!        fif(ib,ii,jj,kk)=(25.0d0*tr1+150.0d0*tr2   
!     & -15.0d0*tr3 +150.0d0*tr4+900.0d0*tr5-90.0d0*tr6   
!     & -15.0d0*tr7 -90.0d0*tr8+9.0d0*tr9)/1024.0d0
!        ii=2*i-pl+1; jj=2*j-pl; kk=2*k-pl-1; !(j+1,k)
!        fif(ib,ii,jj,kk)=(-15.0d0*tr1 +150.0d0*tr2   
!     & +25.0d0*tr3 -90.0d0*tr4+900.0d0*tr5+150.0d0*tr6   
!     & +9.0d0*tr7 -90.0d0*tr8-15.0d0*tr9)/1024.0d0
!        ii=2*i-pl+1; jj=2*j-pl-1; kk=2*k-pl; !(j,k+1)
!        fif(ib,ii,jj,kk)=(-15.0d0*tr1 -90.0d0*tr2   
!     & +9.0d0*tr3 +150.0d0*tr4+900.0d0*tr5-90.0d0*tr6   
!     & +25.0d0*tr7 +150.0d0*tr8-15.0d0*tr9)/1024.0d0
!        ii=2*i-pl+1; jj=2*j-pl; kk=2*k-pl; !(j+1,k+1)
!        fif(ib,ii,jj,kk)=(9.0d0*tr1 -90.0d0*tr2   
!     & -15.0d0*tr3 -90.0d0*tr4+900.0d0*tr5+150.0d0*tr6   
!     & -15.0d0*tr7 +150.0d0*tr8+25.0d0*tr9)/1024.0d0
...
!     & +3.0d0*fi(i,j-1,k-1) +15.0d0*fi(i,j,k-1)   
!     & -2.0d0*fi(i,j+1,k-1) +15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   -15.0d0*fi(i,j+1,k)   
!     & -2.0d0*fi(i,j-1,k+1) -15.0d0*fi(i,j,k+1) +1.0d0*fi(i,j+1,k+1))
!        ii=2*i-pl; jj=2*j-pl; kk=2*k-pl-1; !(j+1,k)
!        fif(ib,ii,jj,kk)=0.0078125*(
!     & -2.0d0*fi(i,j-1,k-1) +15.0d0*fi(i,j,k-1)   
!     & +3.0d0*fi(i,j+1,k-1) -15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   +15.0d0*fi(i,j+1,k)   
!     & +1.0d0*fi(i,j-1,k+1) -15.0d0*fi(i,j,k+1) -2.0d0*fi(i,j+1,k+1))
!        ii=2*i-pl; jj=2*j-pl-1; kk=2*k-pl; !(j,k+1)
!        fif(ib,ii,jj,kk)=0.0078125*(
!     & -2.0d0*fi(i,j-1,k-1) -15.0d0*fi(i,j,k-1)   
!     & +1.0d0*fi(i,j+1,k-1) +15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   -15.0d0*fi(i,j+1,k)   
!     & +3.0d0*fi(i,j-1,k+1) +15.0d0*fi(i,j,k+1) -2.0d0*fi(i,j+1,k+1))
!        ii=2*i-pl; jj=2*j-pl; kk=2*k-pl; !(j+1,k+1)
!        fif(ib,ii,jj,kk)=0.0078125*(
!     & +1.0d0*fi(i,j-1,k-1) -15.0d0*fi(i,j,k-1)   
!     & -2.0d0*fi(i,j+1,k-1) -15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   +15.0d0*fi(i,j+1,k)   
!     & -2.0d0*fi(i,j-1,k+1) +15.0d0*fi(i,j,k+1) +3.0d0*fi(i,j+1,k+1))
!        ii=2*i-pl+1; jj=2*j-pl-1; kk=2*k-pl-1; !avg(j,k)
...
!     & +128.0d0*fi(i+1,j,k)   -15.0d0*fi(i+1,j+1,k)   
!     & -2.0d0*fi(i+1,j-1,k+1) -15.0d0*fi(i+1,j,k+1)
!     & +1.0d0*fi(i+1,j+1,k+1))
!        ii=2*i-pl+1; jj=2*j-pl; kk=2*k-pl-1; !avg(j+1,k)
!        fif(ib,ii,jj,kk)=0.00390625*(
!     & -2.0d0*fi(i,j-1,k-1) +15.0d0*fi(i,j,k-1)   
!     & +3.0d0*fi(i,j+1,k-1) -15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   +15.0d0*fi(i,j+1,k)   
...
!        ii=2*i-pl+1; jj=2*j-pl-1; kk=2*k-pl; !avg(j,k+1)
!        fif(ib,ii,jj,kk)=0.00390625*(
!     & -2.0d0*fi(i,j-1,k-1) -15.0d0*fi(i,j,k-1)   
!     & +1.0d0*fi(i,j+1,k-1) +15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   -15.0d0*fi(i,j+1,k)   
...
!     & +3.0d0*fi(i+1,j-1,k+1) +15.0d0*fi(i+1,j,k+1)
!     & -2.0d0*fi(i+1,j+1,k+1))
!        ii=2*i-pl+1; jj=2*j-pl; kk=2*k-pl; !avg(j+1,k+1)
!        fif(ib,ii,jj,kk)=0.00390625*(
!     & +1.0d0*fi(i,j-1,k-1) -15.0d0*fi(i,j,k-1)   
!     & -2.0d0*fi(i,j+1,k-1) -15.0d0*fi(i,j-1,k)
!     & +128.0d0*fi(i,j,k)   +15.0d0*fi(i,j+1,k)   
...
!     & +3.0d0*fi(i+1,j+1,k+1))
        ...
        do k=no1,nkc+no2; do j=no1,njc+no2; do i=no1-1,nic+no2
...
!=====> previous cor #3
        if (dom(ib)%corprev3.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%corprev3)) then
              ...
              st1=1; st2=1; st3=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%corprev3)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do pl3=st3,pl
                 ijk=pl1*pll+pl2*(pl+1)+pl3+1
...
!=====> previous cor #4
        if (dom(ib)%corprev4.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%corprev4)) then
              ...
              st1=1; st2=1; st3=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%corprev4)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do pl3=st3,pl
                 ijk=pl1*pll+pl2*(pl+1)+pl3+1
...
!=====> next cor #1
        if (dom(ib)%cornext1.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%cornext1)) then
              ...
              st1=1; st2=1; st3=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%cornext1)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do pl3=st3,pl
                 ijk=pl1*pll+pl2*(pl+1)+pl3+1
...
!=====> next cor #2
        if (dom(ib)%cornext2.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%cornext2)) then
              ...
              st1=1; st2=1; st3=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%cornext2)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do pl3=st3,pl
                 ijk=pl1*pll+pl2*(pl+1)+pl3+1
...
!=====> previous edge #3
        if (dom(ib)%edgprev3.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%edgprev3)) then
              ...
              st1=1; st2=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%edgprev3)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do nn=jspr,jepr
                 ijk=(nn-1)*pll+pl1*(pl+1)+pl2+1
...
!=====> next edge #1
        if (dom(ib)%edgnext1.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%edgnext1)) then
              ...
              st1=1; st2=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%edgnext1)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do nn=jspr,jepr
                 ijk=(nn-1)*pll+pl1*(pl+1)+pl2+1
...
!=====> next edge #5
        if (dom(ib)%edgnext5.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%edgnext5)) then
              ...
              st1=1; st2=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%edgnext5)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do nn=kspr,kepr
                 ijk=(nn-1)*pll+pl1*(pl+1)+pl2+1
...
!=====> next edge #6
        if (dom(ib)%edgnext6.ge.0) then
           if(rdiv(dom_id(ib)).ne.rdiv(dom(ib)%edgnext6)) then
              ...
              st1=1; st2=1
!              if(LMR.eq.2 .and.
!     & rdiv(dom_id(ib)).lt.rdiv(dom(ib)%edgnext6)) st1=0
              do pl1=st1,pl; do pl2=st2,pl; do nn=kspr,kepr
                 ijk=(nn-1)*pll+pl1*(pl+1)+pl2+1
